...
param workspaces_contoso_support_sf_ai_name string = 'contoso-support-ai'
param accounts_contoso_support_sf_ai_aiservices_name string = 'contoso-support-ai-aiservices'
param workspaces_contoso_support_sf_aiproj_name string = 'contoso-support-aiproj'
param workspaces_apws_contososupportsfai362802272292_name string = 'log-contososupport'

// Necessary for GPT-4
param location string = 'swedencentral'
param searchLocation string = 'eastus'

var openaiSubdomain = '${accounts_contoso_support_sf_ai_aiservices_name}${resourceToken}'
...
resource registries_crcontososupportsfai868026252389_name_repositories_pull 'Microsoft.ContainerRegistry/registries/scopeMaps@2023-11-01-preview' = {
...
resource registries_crcontososupportsfai868026252389_name_repositories_pull_metadata_read 'Microsoft.ContainerRegistry/registries/scopeMaps@2023-11-01-preview' = {
  parent: containerRegistry
...
resource registries_crcontososupportsfai868026252389_name_repositories_push 'Microsoft.ContainerRegistry/registries/scopeMaps@2023-11-01-preview' = {
  parent: containerRegistry
...
resource registries_crcontososupportsfai868026252389_name_repositories_push_metadata_write 'Microsoft.ContainerRegistry/registries/scopeMaps@2023-11-01-preview' = {
  parent: containerRegistry
...
resource registries_crcontososupportsfai868026252389_name_repositories_admin 'Microsoft.ContainerRegistry/registries/scopeMaps@2023-11-01-preview' = {
  parent: containerRegistry
...
resource databaseAccounts_contoso_support_sf_cosmos_name_contoso_outdoor 'Microsoft.DocumentDB/databaseAccounts/sqlDatabases@2023-09-15' = {
  parent: cosmos
...
resource databaseAccounts_contoso_support_sf_cosmos_name_00000000_0000_0000_0000_000000000001 'Microsoft.DocumentDB/databaseAccounts/sqlRoleDefinitions@2023-09-15' = {
  parent: cosmos
...
resource databaseAccounts_contoso_support_sf_cosmos_name_00000000_0000_0000_0000_000000000002 'Microsoft.DocumentDB/databaseAccounts/sqlRoleDefinitions@2023-09-15' = {
  parent: cosmos
...
resource analytics 'Microsoft.OperationalInsights/workspaces@2021-12-01-preview' = {
  name: '${workspaces_apws_contososupportsfai362802272292_name}${resourceToken}'
  location: location
  properties: {
    sku: {
      name: 'PerGB2018'
...
resource databaseAccounts_contoso_support_sf_cosmos_name_contoso_outdoor_customers 'Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers@2023-09-15' = {
  parent: databaseAccounts_contoso_support_sf_cosmos_name_contoso_outdoor
  name: 'customers'
  properties: {
    resource: {
      id: 'customers'
...
resource mlHub 'Microsoft.MachineLearningServices/workspaces@2023-08-01-preview' = {
  name: workspaces_contoso_support_sf_ai_name
  location: location
  sku: {
    name: 'Basic'
    tier: 'Basic'
  ...
  properties: {
    friendlyName: workspaces_contoso_support_sf_ai_name
...
resource mlProject 'Microsoft.MachineLearningServices/workspaces@2023-10-01' = {
  name: workspaces_contoso_support_sf_aiproj_name
  location: location
  sku: {
    name: 'Basic'
    tier: 'Basic'
  ...
  properties: {
    friendlyName: workspaces_contoso_support_sf_aiproj_name
    hbiWorkspace: false
    v1LegacyMode: false
    publicNetworkAccess: 'Enabled'
    discoveryUrl: 'https://swedencentral.api.azureml.ms/discovery'
